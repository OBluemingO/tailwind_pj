  ...
  return (
    <>
      ...
      <div className='w-full mx-auto '>
        <div className=' mx-auto sm:mt-[5%] md:mt-0 sm:gap-[50px] md:gap-0 xl:gap-[120px] flex justify-center sm:flex-col-reverse md:flex-row xl:mb-[60px] sm:items-center md:pt-[80px] xl:items-end sm:h-[667px] md:h-screen md:max-h-[550px] xl:max-h-[847px] bg-[#F1F1F1]' >
          <div className="flex flex-col sm:items-center md:items-start sm:gap-[10px] xl:gap-[52px] xl:mb-[170px]">
            <h1 className='sm:text-center md:text-start sm:text-2xl md:text-4xl xl:text-7xl font-light'>
              Collections
            </h1>
            <p className='sm:text-center md:text-start xl:leading-[55px] md:text-base xl:text-3xl whitespace-pre-wrap sm:w-[250px] md:w-[375px] xl:w-[682px]'>
              you can explore ans shop many differnt collection
              from various barands here.
            </p>
            <div className='cursor-pointer text-white md:text-base xl:text-[20px] grid items-center md:h-[50px] sm:w-[150px] md:w-[200px] xl:h-[72px] xl:w-[223px] text-center bg-[#1E2832] capitalize'>
              shop now
            </div>
          </div>
          <div className='sm:w-[200px] sm:h-[250px] md:w-[300px] md:h-[400px] xl:w-[424px] xl:h-[542px] relative'>
        ...
        <div className='
        sm:my-[50px] xl:my-[90px] gap-2 max-h-[70px] h-screen mx-auto 
          sm:w-[87.5%]
          ...
          <div className='fake animate-carousel flex gap-3'>
            {
              slider_looping.map(el => <IconCard {...el} key={el.head} />)
            }
          </div>
        </div>
        <div className='mx-auto w-full sm:w-[85%] md:w-[90%] xl:h-[648px] xl:max-w-[1336px] sm:mb-[80px] xl:mb-[140px] flex'>
          {
            categories.length > 0 ?
              <>
                <div className='basis-1/2 grid place-items-center relative'>
                  <h1 className='absolute sm:-left-20 md:-left-28 xl:-left-52 rotate-90 top-1/2 sm:text-[10px] md:text-base xl:text-3xl'>Explore new and popular styles</h1>
                  <div className='h-full sm:w-[95%] md:w-11/12 overflow-hidden'>
                ...
                <div className='basis-1/2 flex flex-wrap overflow-hidden'>
                  ...
                  <div className=' h-[50%] w-[50%] overflow-hidden sm:px-1 md:px-2 pt-2'>
        ...
        <div className='bg-[#F1F1F1]'>
          <div className='mx-auto sm:max-w-[87%] xl:max-w-[1320px] md:h-[700px] xl:h-[1250px]  flex flex-col sm:gap-5 xl:gap-10'>
              ...
              <div className='h-full flex gap-3'>
                {
                  categories.length > 0 ?
                    categories.slice(0, 5).map(el =>
                      <div className={`cursor-pointer sm:text-sm md:text-base h-full flex items-center ${active === 'btn-' + el.id ? 'text-black' : 'text-gray-500'}`} id={`btn-${el.id}`} key={`btn-${el.id}`} onClick={(e) => handleClickMenuNewProduct(e, el.id)}> {el.id == 3 ? 'chair' : el.name} </div>
                    )
                    : null
                }
              </div>
            </div>
            <div className='sm:pb-[50px] md:pb-0 md:h-[450px] xl:h-[988px] w-full  flex flex-wrap justify-between relative sm:gap-2'>
              {
                data.length > 0 ?
        ...
        <div className="flex justify-end sm:h-[350px] md:h-[450px] xl:h-[776px] xl:w-full bg-[url('/image/banner.png')] xl:bg-cover bg-fixed">
          <div className='sm:w-full  md:basis-1/2  text-white flex flex-col sm:items-center md:items-start sm:justify-center md:justify-end md:mb-20 z-30'>
            <h1 className='sm:text-3xl md:text-5xl xl:text-8xl sm:mb-[15px] md:mb-[25px] xl:mb-[56px]'>
              ZARA
            </h1>
            <p className='sm:w-[75%] sm:text-center md:text-start md:w-[400px] xl:w-[504px] sm:text-xs md:text-base xl:text-[26px] sm:mb-[25px] xl:mb-[66px]'>Lustrous yet understated. The new evening
              wear collection exclusively offered at the
              reopened Giorgio Armani boutique in Los
              Angeles.</p>
            <button className='md:text-[29px] w-2/6 bg-slate-600 sm:w-[150px] md:w-full md:max-w-[250px] xl:max-w-[264px] '>see collection</button>
          </div>
        </div>
        <div className='bg-[#F1F1F1] pb-6 mb-10'>
          <div className='sm:max-w-[87%] mx-auto xl:max-w-[1320px] xl:h-[632px] flex flex-col sm:gap-5 xl:gap-10 xl:mb-[140px]'>
            ...
            <div className='md:h-[300px] xl:h-[988px] w-full flex flex-wrap justify-between sm:gap-2 md:gap-0'>
              {
                dataSeller.length > 0 ?
        ...
        <div className='flex flex-col items-center sm:gap-[20px] md:gap-[30px] xl:gap-[60px]'>
          <h1 className='sm:text-2xl md:text-3xl xl:text-5xl sm:text-center md:text-start'>Follow products and discounts on Instagram</h1>
          <div className='flex justify-between w-full sm:max-w-[87%] xl:max-w-[1320px] xl:h-[200px] bg-white sm:gap-2 xl:gap-0'>
            {
              data.length > 0 ?
          ...
          <div>
            <h1 className='sm:text-xl md:text-3xl xl:text-5xl capitalize'>Or subscribe to the newsletter</h1>
